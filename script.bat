...
gsc -sDEVICE=jpeg -dTextAlphaBits=4 -r300 -o public\images\%dir_name%\SDimages\image_%%03d.jpg in.pdf
gsc -sDEVICE=jpeg -dTextAlphaBits=4 -r600 -o public\images\%dir_name%\HDimages\image_%%03d.jpg in.pdf